...
description: "AI 编码执行技能。Activation restricted: use only when the user explicitly names `ai-implementation-execution`, or `ai-feature-orchestrator` explicitly routes here with complete route payload. Do not auto-trigger for ordinary coding, bug fixing, config edits, or implementation requests."
---
