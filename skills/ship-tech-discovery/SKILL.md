...
- target project 未明确，且无法通过 `.docs/ship/project.yml` 或 feature `meta.yml.spec_context` 确定
...
```
1. 读取 requirements.md + meta.yml + target project 配置
   verify: project_context、project_scope、Domain ID、AC ID、target project 已确认
