...
2. 读取指定目录下的 `discovery.md`、`requirements.md`、`design.md`、`tasks.md`、`verification.md`、`handoff.md`。
3. 根据“阶段推断”判断当前阶段。
...
- `discovery.md` / `requirements.md` / `design.md` / `tasks.md`：只能使用 `draft` / `ready` / `blocked`；完成当前阶段时标记为 `ready`，不能标记为 `complete`。
