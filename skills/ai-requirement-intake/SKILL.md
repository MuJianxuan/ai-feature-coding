...
更新 `requirements.md` 和 `resource/README.md`。如果仍有阻塞问题，在 `requirements.md` frontmatter 将 `stage_status` 标记为 `blocked`，并在“待确认问题”中记录；如果范围和 acceptance criteria 已稳定，将 `stage_status` 标记为 `ready`。输出下一步建议后停止。
